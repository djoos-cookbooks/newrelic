...
newrelic_agent_ruby 'Install' do
  ...
  template_cookbook node['newrelic']['ruby_agent']['template_cookbook'] unless node['newrelic']['ruby_agent']['template_cookbook'].nil?
  template_source node['newrelic']['ruby_agent']['template_source'] unless node['newrelic']['ruby_agent']['template_source'].nil?
  ...
  app_user node['newrelic']['ruby_agent']['app_user'] unless node['newrelic']['ruby_agent']['app_user'].nil?
  app_group node['newrelic']['ruby_agent']['app_group'] unless node['newrelic']['ruby_agent']['app_group'].nil?
  owner node['newrelic']['ruby_agent']['app_user'] unless node['newrelic']['ruby_agent']['app_user'].nil?
  group node['newrelic']['ruby_agent']['app_group'] unless node['newrelic']['ruby_agent']['app_group'].nil?
  ...
  audit_mode node['newrelic']['ruby_agent']['audit_mode'] unless node['newrelic']['ruby_agent']['audit_mode'].nil?
  log_file_count node['newrelic']['ruby_agent']['log_file_count'] unless node['newrelic']['ruby_agent']['log_file_count'].nil?
  log_limit_in_kbytes node['newrelic']['ruby_agent']['log_limit_in_kbytes'] unless node['newrelic']['ruby_agent']['log_limit_in_kbytes'].nil?
  log_daily node['newrelic']['ruby_agent']['log_daily'] unless node['newrelic']['ruby_agent']['log_daily'].nil?
  ...
  install_dir node['newrelic']['ruby_agent']['install_dir'] unless node['newrelic']['ruby_agent']['install_dir'].nil?
  ...
  transaction_tracer_slow_sql node['newrelic']['application_monitoring']['transaction_tracer']['slow_sql'] unless node['newrelic']['application_monitoring']['transaction_tracer']['stack_trace_threshold'].nil?
