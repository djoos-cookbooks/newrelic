...
attribute :daemon_ssl, :kind_of => String, :default => nil
...
attribute :error_collector_enable, :kind_of => String, :default => nil
attribute :error_collector_record_database_errors, :kind_of => String, :default => nil
attribute :error_collector_prioritize_api_errors, :kind_of => String, :default => nil
attribute :browser_monitoring_auto_instrument, :kind_of => String, :default => nil
attribute :transaction_tracer_enable, :kind_of => String, :default => nil
...
attribute :webtransaction_name_remove_trailing_path, :kind_of => String, :default => nil
...
attribute :cross_application_tracer_enable, :kind_of => String, :default => nil
