...
default['newrelic']['application_monitoring']['daemon']['location'] = '/usr/bin/newrelic-daemon'
default['newrelic']['application_monitoring']['daemon']['collector_host'] = 'collector.newrelic.com'
...
default['newrelic']['application_monitoring']['error_collector']['ignore_errors'] = true
